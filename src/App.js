import { AccumulativeShadows, Environment, Float, Lightformer, MeshTransmissionMaterial, RandomizedLight, useGLTF } from '@react-three/drei'
  ...
  return (
    <>
      <Canvas shadows camera={{ position: [5, 0, 15], fov: 30 }}>
        ...
        <Selector>
          <Porsche scale={1.4} position={[-0.5, -0.28, 0]} rotation={[0, Math.PI / 5, 0]} />
        </Selector>
